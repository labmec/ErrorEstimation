...
Plane Surface(4) = {4};
//+
Physical Curve("Boundaries", 2) = {10, 8, 4, 3, 1, 2, 13, 5, 11, 12};
//+
Physical Surface("Domain", 1) = {1, 2, 4, 3};
//+
Transfinite Curve {1, 10, 7, 8, 6, 11, 12, 2, 3, 9, 4, 5, 13} = 5 Using Progression 1;
//+
