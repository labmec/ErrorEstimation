...
TPZDarcyMHMHDivErrorEstimator::TPZDarcyMHMHDivErrorEstimator(ProblemConfig &config, TPZMultiphysicsCompMesh &originalMesh, TPZMHMixedMeshControl *mhm, bool postProcWithHDiv): TPZMHMHDivErrorEstimator<TPZMixedDarcyFlow>(config, originalMesh, mhm, postProcWithHDiv) {
}
