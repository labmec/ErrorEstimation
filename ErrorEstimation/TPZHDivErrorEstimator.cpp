...
void TPZHDivErrorEstimator<MixedMaterial>::ComputeAverage(TPZCompMesh *pressuremesh, int64_t iel) {
    ...
    if (noHangingSide) {
        ...
        // We denote "left" the side at volumeNeighSides[0] and "right" the other.
...
template <typename MixedMaterial>
void TPZHDivErrorEstimator<MixedMaterial>::PlotPrimalSkeleton(const std::string &filename, std::set<int> matids) {
