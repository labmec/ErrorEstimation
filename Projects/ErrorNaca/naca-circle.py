...
def main():
    ...
    #%% Creating the rectangular boundary
    rectangle_coord: list[float] = [
        [-2, 0, depth], # p11
    ...
    rectangle_coord += [ [x[0], -x[1], depth] for x in rectangle_coord[::-1] if x[1] != 0 ]

    # Create points
    p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24 = TPZMeshModeling.CreatePoints(rectangle_coord, lc)

    lines_rectangle: list[int] = [
        [p11, p12], # l11
        [p12, p13], # l12
        [p13, p14], # l13
        [p14, p15], # l14
    ...
    l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22, l23, l24 = TPZMeshModeling.CreateLines(lines_rectangle)
    ...
    boundary_coord: list[float] = [
        ...
        [center[0]+radius, center[1], depth], # p26
        [center[0], center[1]+radius, depth], # p27
        [center[0]-radius, center[1], depth], # p28
        [center[0], center[1]-radius, depth] # p29
    ]

    # Create points
    p25, p26, p27, p28, p29 = TPZMeshModeling.CreatePoints(boundary_coord, lc)
    ...
    l37, l38, l39, l40 = TPZMeshModeling.CreateCircleArcs(lines_boundary)

    lines_radial: list[int] = [
        [p21, p27]] # l41
    
    l41 = TPZMeshModeling.CreateLines(lines_radial)
    ...
    curve_loops: list[int] = [
        ...
        [l35, l23, l36, l2], # cl11
        [l36, l24, l25, l1], # cl12
        [l37, l38, l39, l40], # cl13
        [l11, l12, l13, l14, l15, l16, l17, l18, l19, l20, l21, l22, l23, l24] # cl14
    ]
    ...
    # Embedding line 41 in surface 13
    TPZMeshModeling.Embed(1,[l41], 2, surfaces[-1])
...
#        [(dim, tag), ID, "name"]
    ...
    dim = 1 # dimension of the entity
    tag = [l37,l38,l39,l40] # tag of the entity
    ID = 3
    gp = [
#        [(dim, tag), ID, "name"]
    ...
    TPZMeshModeling.RecombineSurface(domain_surfaces)
